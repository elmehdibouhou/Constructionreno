...
highlights:
  ...
  - "Main floor: mudroom with built-ins, laundry suite, and dog wash station"
  - "Upper floor: primary suite with walk-in closet and luxury ensuite"
  - "Exterior brick, windows, and roofline matched to existing home"
  - "All structural connections engineered and inspected"
  - "Interior finishes matched to existing home throughout"
galleryImages:
