...
highlights:
  ...
  - "All existing sectional gutters and rotted fascia removed and replaced"
  - "K-style leaf guard covers installed on all eavestrough runs"
  - "New downspouts with underground drainage extensions, 8 ft from foundation"
  - "Custom colour-matched to existing fascia in Musket Brown"
  - "All spike hangers replaced with hidden screw-in hangers at 24-in spacing"
galleryImages:
